...
%\draw[e](D)--[bend left](W);
\draw[e](D) to [bend left,looseness=1] node[above] {asd} (W);
\draw[e](W) to [bend left,looseness=1] node[above] {asd} (D);
\draw[e](R) to [bend left,looseness=1] node[above] {asd} (A);
\draw[e](A) to [bend left,looseness=1] node[above] {asd} (D);
\draw[e](W) to [bend left,looseness=1] node[above] {asd} (R);
\draw[e](W) to  node[above] {asd} (A);
